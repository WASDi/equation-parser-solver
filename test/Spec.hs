...
testSimplifier =
  ...
  , assertSimplify "(30-x)+1" "31-x"
  , assertSimplify "(30-x)-1" "29-x"
  , assertSimplify "(40+x)+1" "41+x"
  , assertSimplify "(40+x)-1" "39+x"
  , assertSimplify "(x-50)+1" "x-49"
  , assertSimplify "(x-50)-1" "x-51"
  , assertSimplify "-(-(1+1))" "2"
